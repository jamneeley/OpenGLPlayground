...
object TextureHelper {
    ...
    fun loadTexture(context: Context, resourceID: Int): Int {
        ...
        GLES30.glTexParameteri(GLES30.GL_TEXTURE_2D, GLES30.GL_TEXTURE_MAG_FILTER, GLES30. GL_LINEAR) //tell openGL to use bilinear filtering for Magnification with tje bound texture
